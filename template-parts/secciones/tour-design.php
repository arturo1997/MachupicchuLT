        ...
        <div class="wrapper">
            ...
            <div class="hero-entrada-content-view">
                <div class="tour-details">
                    ...
                    <h1 class="tour-titulo"><?php the_title(); ?></h1>
                    <div class="tour-precio">
                        Desde <span class="tour-precio-numero">US$<?php echo get_field('precio') ?></span> por Persona
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="main-sidebar-content">
                            ...
                            <ul class="atencion-al-cliente-list">
                                <li>
                                    ...
                                    <a class="atencion-al-cliente-email"
                                        href="mailto:info@machupicchulunatours.com">info@machupicchulunatours.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="tripadvisor">
                        <a target="_blank"
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/images/tripadvisor.png" width=""
                                height="" alt="" />
                        </a>
                    </div>
                </div>
        ...
        <div class="toursRelacionados">
            <div class="wrapper">
                <h2 class="container-section-title">
                    Tours <span class="title-color">Relacionados</span>
                </h2>
                <div class="owl-carousel owl-carousel-3">
                    <?php include(TEMPLATEPATH."/template-parts/secciones/tours-relacionados.php");?>
                </div>
            </div>
        </div>